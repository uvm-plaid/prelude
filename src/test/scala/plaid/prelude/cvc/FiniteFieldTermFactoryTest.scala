...
class FiniteFieldTermFactoryTest {

  /**
   * Two numbers generated by two different term managers are not equal. This
   * test establishes how the underlying CVC5 implementation works.
   */
  @Test
  def compareElements(): Unit =
    val termManager1 = TermManager()
    val termManager2 = TermManager()
    val sort1 = termManager1.mkFiniteFieldSort("7", 10)
    val sort2 = termManager2.mkFiniteFieldSort("7", 10)
    val minusOne1 = termManager1.mkFiniteFieldElem("-1", sort1, 10)
    val minusOne2 = termManager2.mkFiniteFieldElem("-1", sort2, 10)
    assertNotEquals(minusOne1, minusOne2)
  ...
  def compareTermsFromTermManagers(): Unit =
    val tm = TermManager()
    val sort = tm.mkFiniteFieldSort("7", 10)
  ...
  def trueConstraintTerm(): Unit =
    ...
    assertEquals(factory.termManager.mkTrue(), term)
